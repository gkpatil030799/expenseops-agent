...
| --- | --- | --- |
| `get_spending_insights` | Required ISO start/end dates, at most 730 days; optional account, category, merchant, review type, spend basis, and three-letter currency | Current and comparable aggregates; up to 10 categories, 10 merchants, 4 notable changes, and 16 available currencies; explicit cross-currency and pending exclusions. |

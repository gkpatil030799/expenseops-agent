...
import type { AgentMessage, AgentPageContext } from "./contracts";
    ...
    >
      <header className="border-b border-slate-200 bg-gradient-to-r from-slate-950 to-indigo-950 px-4 py-3 text-white">
        ...
        <div className="mt-3 flex items-center justify-between gap-3">
          <Badge className="max-w-full border-white/15 bg-white/10 text-indigo-50" variant="secondary">
            <span className="truncate">Using context: {contextLabel}</span>
          </Badge>
          {hasConversation ? (
            <button
              type="button"
